...
Файл с данным в формате jsonlines.bz2 

##### Как прочитать файл, используя Python.
...
##### Данные не отсортированы по матчам!
##### Обратите внимание на этот формат, т.к. именно в таком формате поступают данные о матчах в реальном времени (см. описание [API вызова /api/match/<id>/status](https://github.com/romovpa/dotascience-hackathon#Состояние-матча-в-текущий-момент-времени))
